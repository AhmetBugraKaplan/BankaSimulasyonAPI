...
@Component({
  selector: 'app-cepten-al-gonderen-cepno-giris',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './cepten-al-gonderen-cepno-giris.html',
  styleUrl: './cepten-al-gonderen-cepno-giris.css',
})
export class CeptenAlGonderenCepnoGiris implements AfterViewInit {
  ...
  devam(): void {
    ...
    sessionStorage.setItem('ceptenAlGonderenTelNo', raw);
